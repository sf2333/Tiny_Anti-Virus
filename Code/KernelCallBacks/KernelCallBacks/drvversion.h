...
#define DRV_YEAR               2016 // current year or timespan (e.g. 2003-2009)
...
#define TEXT_MODULE            importTableInjectDll // module name
...
#define TEXT_INTERNALNAME      importTableInjectDll.sys // copyright information
